function [ cuboid_descriptor, descriptor_num, subs ] = my_rgb3d_dense_sample( cuboid,...
	nbins, nind, hNum, wNum, lNum, hOlp, wOlp, lOlp)
...
for x=1:hNum
    for y=1:wNum
        for t=1:lNum
            ...
            cuboid_descriptor(:,tt) = my_rgb3dhist_fast(block,nbins,nind);
            subs(tt,:)=[x,y,t];
            tt = tt+1;
        end
    end
